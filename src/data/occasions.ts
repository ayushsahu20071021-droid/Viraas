...
export const occasions: Occasion[] = [
  ...
  O('navratri', 'Navratri', 'Nine nights of mirrorwork, kud and cardio', '/images/occasion-navratri.jpg',
    ...
    ['Hot Pink', 'Parrot Green', 'Sunflower Yellow', 'Copper'], ['garba', 'sangeet', 'college-fest']),
  O('wedding', 'Wedding', 'Heirloom weight, modern restraint', '/images/occasion-wedding.jpg',
    ...
    { women: 'Banarasi or Chanderi silk for rituals; pre-draped satin for the reception', men: 'Bandhgala or sherwani weight kurta-set; brocade jacket over ivory linen for day; tailored Wedding Formals for the reception' },
  ...
  O('mehendi', 'Mehendi', 'Yellow, marigold and zero regret about getting henna on the outfit', '/images/occasion-mehendi.jpg',
    ...
    ['Marigold', 'Peach', 'Lilac', 'Mint'], ['haldi', 'wedding', 'family-function']),
  ...
  O('haldi', 'Haldi', 'Turmeric, marigolds and clothes that photograph like sunshine', '/images/occasion-mehendi.jpg',
    ['Haldi is the happiest chaos on the wedding calendar: petals, pichkaris and a yellow cloud that lands on everyone equally. Dress in the marigold-to-ochre band — mustard, turmeric yellow, ivory — in fabrics that take a stain and shrug it off: cotton, mul, handloom.', 'Our rule: the outfit should look like it was chosen for the photos, not sacrificed to them. Lighter weaves, shorter hemlines, jewellery you can remove with one wet hand.'],
    { women: 'Mustard or ivory kurti-set, sharara or printed lehenga in cotton-silk', men: 'Ivory or mustard cotton kurta with a contrasting stole and kolhapuris' },
    ['Wear sunscreen under the outfit plan — haldi is an outdoor sport', 'Flower jewellery beats metal near henna hands', 'Keep sleeves short of the wrist; everything gets turmeric-ed equally'],
    ['Marigold', 'Butter Yellow', 'Turmeric', 'Ivory'], ['mehendi', 'wedding', 'college-fest']),
  O('garba', 'Garba & Dandiya', 'Nine nights, two dandiyas, one spin-proof outfit', '/images/occasion-navratri.jpg',
    ['Garba is a sport with a dress code: hours of circling, clapping and dandiya strikes under stadium lights. The modern garba wardrobe keeps the craft — bandhani, mirror work, gota — and updates the fit: lighter chaniya cholis with real support, contemporary kediya sets with tapered trousers, footwear broken in by night one.', 'This is VIRAAS at its most youthful. Every pick here is chosen for spin: flare that opens when you turn, fabrics that breathe at midnight, and colours that read from the last row of the circle.'],
    { women: 'Contemporary chaniya choli or printed lehenga with mirror-work odhani; block heels you can dance in', men: 'Modern kediyu set or kurta with a festive vest and tapered trousers' },
    ['Belt the choli with a cord, not a clasp — clasps lose wars by hour two', 'Braid the hair with a paranda; loose hair is a fidget you cannot stop touching', 'Choose mirror work over sequins — it throws light with every turn of the circle'],
    ['Hot Pink', 'Parrot Green', 'Sunflower Yellow', 'Copper'], ['navratri', 'college-fest', 'sangeet']),
]
