...
export const occasions: Occasion[] = [
  ...
  O('haldi', 'Haldi', 'Turmeric, marigolds and clothes that photograph like sunshine', '/images/occasion-haldi.jpg',
  ...
  O('garba', 'Garba & Dandiya', 'Nine nights, two dandiyas, one spin-proof outfit', '/images/occasion-garba.jpg',
