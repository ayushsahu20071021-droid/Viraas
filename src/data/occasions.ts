...
export const occasions: Occasion[] = [
  ...
  O('navratri', 'Navratri', 'Nine nights of mirrorwork, colour and cardio', '/images/occasion-navratri.jpg',
    ...
    { women: 'Chaniya-choli, flared lehenga or mirror-work ethnic set with an odhani', men: 'Kediyu, printed festive shirt or textured kurta with one considered layer' },
  ...
  O('college-fest', 'College Fest', 'Young, expressive and budget-aware Indian festive style', '/images/occasion-college.jpg',
    ...
    { women: 'Light ethnic set, chaniya-inspired skirt, kurta with denim or easy festive co-ord', men: 'Printed ethnic shirt, short kurta, modern kediyu or relaxed festive layer' },
